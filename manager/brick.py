...
import ev3.error as error
import ev3.asynchronous as asynchronous
import ev3.battery as battery


_MODULE_LOGGER = logging.getLogger('manager.brick')
...
class Brick(object):
    def __init__(self, communication_object):
        ...
        self.manager = None  # should be the server
    ...
    def send_command(self, cmd, immediate_return=False):
        #review: send cmd or res to spectators
    ...
    def callback_wrapper(self, data):
        self.subscription.add_event(data)
        #review: send sub to server
    ...
    def set_subscription(self, subscription):
        ...
        self._message_handler.set_callback(self.callback_wrapper)
