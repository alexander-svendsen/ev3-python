# source: https://github.com/opiate/SimpleWebSocketServer
...
class WebSocket(object):
        ...
        if self.handshaked is False:
            ...
            if data:
                ...
                # indicates end of HTTP header
                    ...
                    # hixie handshake
                    if self.request.headers.has_key('Sec-WebSocket-Key1'.lower()) and self.request.headers.has_key(
                            'Sec-WebSocket-Key2'.lower()):
    ...
    def handshake_hixie76(self):
        ...
        response = self.hixiehandshakedStr % {'type': typestr, 'origin': self.request.headers['Origin'.lower()],
